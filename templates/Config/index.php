...
<div class="card card-primary card-outline">
    <div class="card-header d-flex flex-column flex-md-row">
        ...
        <div class="d-flex ml-auto">
            ...
            <?= $this->Html->link(__('New Config'), ['action' => 'add'], ['class' => 'btn btn-primary btn-sm ml-2']) ?>
        </div>
    </div>
    <!-- /.card-header -->
                ...
                <?php foreach ($config as $config) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $config->id], ['class' => 'btn btn-xs btn-outline-danger', 'escape' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $config->id)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
