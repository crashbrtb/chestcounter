...
<div class="content-page-wrap">
    <div class="score-toolbar">
        <div>
            <h1 class="score-title"><?= __('Admin Pending Bank Approvals') ?></h1>
            <p class="cycle-subtitle"><?= __('Approve or reject transactions. Approved entries update member balances immediately') ?></p>
        </div>
        <div class="actions">
            <?= $this->Html->link('<i class="fas fa-arrow-left mr-1"></i> ' . __('Back to Bank'), ['controller' => 'Bank', 'action' => 'index'], ['class' => 'btn btn-default btn-sm', 'escape' => false]) ?>
        </div>
    </div>

    <div class="card ranking-card">
        <div class="ranking-header">
            <h3 class="card-title"><?= __('Pending Approvals Queue') ?></h3>
        </div>
