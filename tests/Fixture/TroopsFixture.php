...
class TroopsFixture extends TestFixture
{
    ...
    public function init(): void
    {
        $this->records = [
            ...
            // Deliberately not a real unit: the slug can never gain a portrait,
            // so this keeps exercising the tier-badge fallback however many
            // portraits get captured for the real catalogue.
            $this->row([
                'id' => 9,
                'slug' => 'fixture-no-portrait',
                'name' => 'Unportrayed Engine',
                'troop_class' => 'engineer',
                'category' => 'siege',
                'level' => 1,
                'strength' => 250,
